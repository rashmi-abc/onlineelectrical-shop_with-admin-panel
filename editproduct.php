...
{
$original_product_name=$_POST['old_product_name'];
...
if ($picture_type == "image/jpeg" || $picture_type == "image/jpg" || $picture_type == "image/png" || $picture_type == "image/gif") {
  ...
  die("Invalid picture type");
}
// Fetch existing image name if no new image is uploaded
$result = mysqli_query($con, "SELECT product_image FROM products WHERE product_title='$original_product_name'") or die("Query incorrect");
$product = mysqli_fetch_assoc($result);
$picture_name = $product['product_image'];
}
mysqli_query($con,"UPDATE products SET 
                        ...
                        product_keywords='$tags' 
                     WHERE product_title='$original_product_name'");
              ...
              <div class="card-body">
                  ...
                  <div class="col-md-12">
                      <div class="form-group">
                        <label>Old Product Title</label>
                        <input type="text" id="old_product_name" required name="old_product_name" class="form-control">
                      </div>
                    <div class="col-md-12">
                      <div class="form-group">
